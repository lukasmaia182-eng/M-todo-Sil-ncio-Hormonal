...
export default function MembrosPage() {
  ...
  const [userName, setUserName] = useState('Bem-vinda')
...
function EbookSection() {
  const chapters = [
    { num: 1, title: 'O Que É Narcisismo — De Verdade' },
    { num: 2, title: 'Como o Vínculo Traumático Se Forma' },
    { num: 3, title: 'Os Sinais que Ignoramos — e Por Quê' },
    { num: 4, title: 'Gaslighting: Quando a Realidade É Sequestrada' },
    { num: 5, title: 'O Processo de Cura' },
    { num: 6, title: 'Limites: A Arte de Se Proteger com Amor' },
    { num: 7, title: 'Construindo o Futuro que Você Merece' },
  ]
    ...
    <div className="flex flex-col gap-3">
      <div className="bg-white rounded-2xl p-5 border border-[var(--color-border)] shadow-sm">
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] mt-1 leading-relaxed">
          Leitura aprofundada para complementar sua jornada dos 21 dias. Avance nos capítulos no seu ritmo.
        </p>
      </div>
        ...
        {chapters.map((cap) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs text-[var(--color-muted-foreground)] font-medium">Capítulo {cap.num}</p>
